...
namespace CROSSWORKERS.CHEMICLEAN.Service
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ChemiCleanContext>(options =>
            ...
            services.AddScoped<IRepository<Product>,ChemiCleanRepository<Product>>();
